...
-- DSL
KNOT <knot_name> DATATYPE <data_type>;
...
-- DSL
ATTRIBUTE <attribute_name> ANCHOR <anchor_name> DATATYPE <data_type>;
...
-- DSL
ATTRIBUTE <attribute_name> ANCHOR <anchor_name> KNOT <knot_name>;
